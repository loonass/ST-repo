 ...
 */
 metadata {
	definition (name: "Fibaro Door/Window Sensor", namespace: "smartthings", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
	...
	tiles {
        ...
        standardTile("tamper", "device.tamper") {
			state("secure", label:'secure',    icon:"st.locks.lock.locked",   backgroundColor:"#00a0dc")
			state("tampered", label:'tampered', icon:"st.locks.lock.unlocked", backgroundColor:"#e86d13")
		}
		...
		main(["contact", "tamper"])										//UNCOMMENT ME IF NO TEMP INSTALLED
		details(["contact", "battery", "tamper"])						//UNCOMMENT ME IF NO TEMP INSTALLED
	}
}
