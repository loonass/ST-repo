...
metadata {
	definition(name: "ZLL Dimmer Bulb Countdown Indicator", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.light", runLocally: false, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
		capability "Actuator"
	...
	tiles(scale: 2) {
			...
			state "level", action:"switch level.setLevel", range: "1..100"
            }

		main(["valueTile"])
		details(["valueTile","occurrence","brightness"])
	}
}
