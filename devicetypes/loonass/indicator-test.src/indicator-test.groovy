...
metadata {
	definition(name: "Indicator test", namespace: "loonass", author: "Mike Harvey", ocfDeviceType: "oic.d.light", runLocally: false, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
		capability "Actuator"
