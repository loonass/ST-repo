 ...
 */
 metadata {
	definition (name: "Fibaro Door/Window Sensor", namespace: "loonass", author: "SmartThings", runLocally: false, minHubCoreVersion: '000.021.00001', executeCommandsLocally: true) {
