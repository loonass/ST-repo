...
metadata {
    definition(name: "SmartSense Button", namespace: "loonass", author: "SmartThings", runLocally: true, minHubCoreVersion: '000.022.0000', executeCommandsLocally: false, mnmn: "SmartThings", vid: "SmartThings-smartthings-SmartSense_Button", ocfDeviceType: "x.com.st.d.remotecontroller") {
        ...
        capability "Sensor"
//        capability "Motion Sensor" //uncomment this to add to Alexa then remove once added. You can then use this for temp readings.
